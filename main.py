...
#Class for the LSTM that encodes
...
#Class that implements the LSTM for decoder
...
# Train the model
class da_rnn:
    def __init__(self, file_data, logger, encoder_hidden_size = 64, decoder_hidden_size = 64, T = 10,learning_rate = 0.01, batch_size = 128, parallel = True, debug = False):
        self.T = T
...
model = da_rnn(file_data = './BTC-USD.csv', logger = logger, parallel = False,learning_rate = .001)
